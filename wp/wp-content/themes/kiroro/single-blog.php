...
<div class="c-mv p-mv">
    <div class="c-mv__title">
        <p class="c-mv__title-text">スタッフブログ</p>
    </div>
</div>
<div class="p-content">
    <article class="c-article --blog">
        <div class="l-container">
            <div class="c-article__header">
                <div class="c-article__meta">
                    ...
                    ?>
                        <span class="c-label --blog"><?php echo $category_name; ?></span>
                    <?php endif; ?>
                </div>
            ...
            <div class="u-align-center">
                <a href="<?php echo esc_url( home_url('/blog') ); ?>" class="c-button --primary">一覧へ戻る</a>
            </div>
        </div>
    </article>
</div>
