    ...
    <div class="swiper-wrapper p-swiper__wrapper">
        <div class="swiper-slide p-swiper__slide">
            <picture>
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/mv1.jpg" alt="" class="p-swiper__img --top" fetchpriority="high">
            </picture>
        </div>
        <div class="swiper-slide p-swiper__slide">
            <div class="swiper-slide p-swiper__slide">
                <picture>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/mv2.jpg" alt="" class="p-swiper__img --center" fetchpriority="high">
                </picture>
            </div>
        </div>
    </div>
