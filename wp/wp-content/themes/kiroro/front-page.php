    ...
    <div class="swiper-wrapper c-swiper__wrapper">
        <div class="swiper-slide c-swiper__slide">
            <picture>
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/mv1.jpg" alt="" class="c-swiper__img" fetchpriority="high">
            </picture>
        </div>
        <div class="swiper-slide c-swiper__slide">
            <div class="swiper-slide c-swiper__slide">
                <picture>
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/mv2.jpg" alt="" class="c-swiper__img" fetchpriority="high">
                </picture>
            </div>
        </div>
    </div>
