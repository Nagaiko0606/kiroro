            ...
            <div class="l-container">
                <div class="l-footer__logo">
                    <a href="<?php echo esc_url(home_url('')); ?>">
                        <picture>
                            <source
                                srcset="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/footer-logo.webp 456w, <?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/footer-logo@2x.webp 912w"
                                type="image/webp" sizes="(max-width : 767px) 83vw, 456px">
                            <!-- 768px以上でWebP非対応ブラウザの場合 -->
                            <img srcset="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/footer-logo.jpg 456w, <?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/footer-logo@2x.jpg 912w"
                                src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/footer-logo.png" alt="新桜町動物医療センター"
